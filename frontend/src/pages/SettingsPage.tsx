              ...
              <tbody>
                {sources.map((s) => (
                  <tr key={s.id} className={s.enabled ? "" : "row-disabled"}>
                    ...
                    <td>{s.video_count + s.photo_count}</td>
      ...
      <section className="settings-section" id="hls-streaming">
        <div className="settings-section-header">
          <div>
            <h2>HLS / Streaming</h2>
            <p className="settings-section-desc">
              Start HLS generation for missing videos and repair stale HLS DB state. Default generation profile: 480p.
            </p>
          </div>
          <div className="settings-inline-actions">
        ...
        <div className="settings-notice">
          Generated HLS profile: <strong>480p</strong>. Original playback remains available for maximum quality.
        </div>
